...
// TLSCfg is the TLS configuration for gRPC server.
type TLSCfg struct {
...
// LoadTLSCfg creates a tls.Config from the given TLS configuration.
...
func LoadTLSCfg(cfg *TLSCfg) (*tls.Config, error) {
	...
	// If no certificate files specified, return nil
